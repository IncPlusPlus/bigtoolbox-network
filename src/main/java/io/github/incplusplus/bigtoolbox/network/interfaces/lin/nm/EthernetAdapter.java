...
public class EthernetAdapter extends GenericDevice
    implements io.github.incplusplus.bigtoolbox.network.interfaces.EthernetAdapter {

  public EthernetAdapter(Device device) {
