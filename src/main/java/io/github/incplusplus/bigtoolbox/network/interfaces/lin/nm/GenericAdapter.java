...
public class GenericAdapter extends GenericDevice
    implements io.github.incplusplus.bigtoolbox.network.interfaces.GenericAdapter {

  public GenericAdapter(Device device) {
