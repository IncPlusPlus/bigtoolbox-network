...
public interface Manager extends DBusInterface, Properties {
  ...
  /**
   * Get a systemd Unit of a certain name. For example, the call GetUnit("NetworkManager.service")
   * returns the path "/org/freedesktop/systemd1/unit/NetworkManager_2eservice"
   *
