...
public enum Dot11CipherAlgorithm implements InteropFlagSet<Dot11CipherAlgorithm, io.github.incplusplus.bigtoolbox.network.wlan.Dot11CipherAlgorithm> {
	...
	//unused
	//	WPA_USE_GROUP(io.github.incplusplus.bigtoolbox.network.wlan.Dot11CipherAlgorithm.WPA_USE_GROUP, 0x100),
	RSN_USE_GROUP(io.github.incplusplus.bigtoolbox.network.wlan.Dot11CipherAlgorithm.RSN_USE_GROUP, 0x100),
	...
	public Dot11CipherAlgorithm from(int hexVal) {
		return Arrays.stream(Dot11CipherAlgorithm.values()).filter(
